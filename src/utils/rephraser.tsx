...
export default function Rephraser({ text }: RephraseToolProps): JSX.Element {
  ...
  return (
    <div className="block px-4 py-2 text-sm text-gray-700 w-full text-left">
      ...
      <button
        className="inline-flex justify-center rounded-md border border-blue-300 shadow-sm px-4 py-2 bg-blue-500 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mt-2 ml-4"
